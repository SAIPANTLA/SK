...
//   // Fetch real-time summary data from backend
//   useEffect(() => {
//     const fetchSummaryCounts = async () => {
//       try {
//         const token = localStorage.getItem("token");
//         const response = await axios.get("http://localhost:8000/api/summary-counts/", {
//           headers: {
//             Authorization: `Bearer ${token}`,
//           },
//         });

//         const { trainees, trainers } = response.data;

//         setSummaryData((prev) =>
//           prev.map((item) => {
//             if (item.title === "Total Trainees") {
//               return { ...item, value: trainees };
//             }
//             if (item.title === "Active Trainers") {
//               return { ...item, value: trainers };
//             }
//             return item;
//           })
//         );
